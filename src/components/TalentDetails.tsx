...
const TalentDetails = ({ talent }: { talent: TalentProps }) => {
  ...
  return (
    <>
        ...
        <div className="mb-4 flex flex-wrap rounded-lg bg-gray-100 p-4 md:flex-nowrap">
          <div className="flex w-full flex-col items-center p-4 md:w-1/3">
            <PrismicNextImage
              ...
              className="mb-4 h-[400px] w-full rounded-lg object-cover shadow-md"
            />
          </div>
          <div className="flex w-full flex-col justify-between p-4 md:w-2/3">
            {talent.vimeo_link?.embed_url && (
              <iframe
                ...
                className="mb-4 h-[400px] w-full rounded-lg shadow-md"
                allowFullScreen
              ></iframe>
            )}
          </div>
      ...
      <div className="m-auto flex w-full items-center justify-between bg-black p-4 text-white">
        <div className="mb-2 w-1/4 text-center">
      ...
      <div className="flex flex-wrap pb-10 pt-10">
        <div className="flex w-full flex-col items-center border-r-2 border-broocksprimary p-4 md:w-1/3">
          {talent.spotlight_link && (
            <PrismicNextLink field={talent.spotlight_link}>
              <Image
                ...
                alt="Spotlight"
                className="w-50 mb-2 h-auto bg-black"
                width="80"
                height="80"
              />
            </PrismicNextLink>
